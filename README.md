...
```mermaid
flowchart TD
    actor1[Usuario] -->|Selecciona 'Ubicaciones'| sistema1[Sistema]
...
```mermaid
flowchart TD
    actor1[Usuario] -->|Selecciona 'Equipos'| sistema1[Sistema]
...
```mermaid
flowchart TD
    actor1[Usuario] -->|Selecciona 'Eventos'| sistema1[Sistema]
...
```mermaid
flowchart TD
    actor1[Usuario] -->|Selecciona 'Coordinadores Docentes'| sistema1[Sistema]
...
```mermaid
flowchart TD
    actor1[Usuario] -->|Selecciona 'Coordinadores Estudiantes'| sistema1[Sistema]
